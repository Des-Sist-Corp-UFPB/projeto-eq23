...
class AtivoServiceTest {
    ...
    void setUp() {
        ...
        formValido = new AtivoForm("Notebook Thinkpad", "T14 Gen 3", "SN-THINK-5678", "ATIVO", java.util.Collections.emptyList());
    }
    ...
    void atualizar_quandoAtivoExiste_deveAtualizarDados() {
        ...
        AtivoForm formAtualizado = new AtivoForm("Notebook Dell Pro", "XPS 13 Developer Edition", "SN-DELL-1234", "ATIVO", java.util.Collections.emptyList());
