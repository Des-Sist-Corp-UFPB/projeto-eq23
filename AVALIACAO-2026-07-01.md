...
✅ **Atendido** — documentado no README e com 130 evidência(s) no código.

---

## 2. Integração com Serviço Externo

- ✅ **Resend** — declarado no README e comprovado no código (18 ocorrência(s)).
  - Evidência: `src/main/java/br/ufpb/dsc/mercado/config/EmailConfig.java:5:import br.ufpb.dsc.mercado.service.ResendEmailService;`

---

## 3. Cobertura de Testes (≥ 85%)

✅ **Atendido** — linhas 86.9% (instruções 82.1% · ramos 45.2%) [JaCoCo] (relatório em `cobertura/`, 103 arquivo(s)).
